          ...
          >
            <motion.div variants={fadeUp}>
              <div className="flex items-center gap-4 mb-8">
                <span className="font-mono text-xs text-[#666]">01</span>
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12">
                    ...
                    <div className="md:col-span-7 order-2 md:order-1">
                      <div className="w-full aspect-[16/10] bg-[#0a0a0a] border border-[#1a1a1a] group-hover:border-[#333] transition-colors duration-500 flex items-center justify-center overflow-hidden">
                        <span className="font-mono text-[11px] text-[#555] uppercase tracking-[0.2em] group-hover:text-[#777] transition-colors duration-500">
                          {project.title}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="md:col-span-5 order-1 md:order-2 flex flex-col justify-between">
                      <div>
                        <div className="flex items-center gap-4 mb-4">
                          ...
                          <span className="font-mono text-[11px] text-[#777] uppercase tracking-[0.15em]">
                            {project.category}
                          </span>
                        </div>
                        <h3 className="font-sans font-bold text-2xl md:text-3xl tracking-tight leading-tight mb-4 group-hover:text-white transition-colors duration-300">
                          {project.title}
                        </h3>
                      ...
                      <div className="flex flex-wrap gap-2 items-center">
                        {project.tags.map((tag) => (
                          <span
                            key={tag}
                            className="font-mono text-[10px] uppercase tracking-[0.1em] text-[#666] border border-[#333] px-2.5 py-1"
                          >
                            {tag}
                          </span>
                        ))}
